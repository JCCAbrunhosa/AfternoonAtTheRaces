...
public class BettingCenter implements BettingCenterInterface {
     ...
     * @param repository
     */
    public BettingCenter(RepositoryInterface repository, Register register){
    ...
    @Override
    public synchronized void placeABet(int specId, double betValue, int horseId, double possibleGain) throws RemoteException {
    ...
    @Override
    public synchronized double goCollectTheGains(int specId) throws RemoteException {
    ...
    @Override
    public synchronized HashMap areThereAnyWinners(int winnerHorse) throws RemoteException {
     ...
     */
    @Override
    public synchronized void areSpectatorsReadyToBet() throws RemoteException {
