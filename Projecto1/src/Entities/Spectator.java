...
import Monitors.BettingCenter;

import Monitors.ControlCenter;
...
public class Spectator extends Thread {
    ...
    private BettingCenter btCenter;
    ...
    private ControlCenter cntrlCenter;
    ...
    public Spectator(int id, double valueForBets, Paddock paddock, BettingCenter btCenter, ControlCenter cntrlCenter, Repository repo){
